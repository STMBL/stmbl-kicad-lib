...
def eurostyle_RM508_up_gen(pins):
    ...
    with open(filename + ".kicad_mod", mode = "w+") as f:
        ...
        # outline
        f.write(line(-3.25, 3.75, rm * (pins - 1) + 3.25, 3.75))
        f.write(line(-3.25, -4.75, rm * (pins - 1) + 3.25, -4.75))
        f.write(line(-3.25, -4.5, rm * (pins - 1) + 3.25, -4.5))
        f.write(line(-3.25, -4.75, -3.25, 3.75))
        f.write(line(rm * (pins - 1) + 3.25, -4.75, rm * (pins - 1) + 3.25, 3.75))

        # plug outline
        f.write(line(-rm / 2, 3.75, rm * (pins - 1) + rm / 2, 3.75, "Margin"))
        f.write(line(-rm / 2, -11.25, rm * (pins - 1) + rm / 2, -11.25, "Margin"))
        f.write(line(-rm / 2, 3.75, -rm / 2, -11.25, "Margin"))
        f.write(line(rm * (pins - 1) + rm / 2, 3.75, rm * (pins - 1) + rm / 2, -11.25, "Margin"))
        ...
        for i in range(pins):
            ...
            f.write(line(rm * i - 1.25, 1, rm * i + 1.25, 1, "Margin"))
            f.write(line(rm * i - 1.25, -1.25, rm * i + 1.25, -1.25, "Margin"))
            f.write(line(rm * i - 1.25, 1, rm * i - 1.25, -1.25, "Margin"))
            f.write(line(rm * i + 1.25, 1, rm * i + 1.25, -1.25, "Margin"))
...
def eurostyle_RM508_gen(pins):
    ...
    with open(filename + ".kicad_mod", mode = "w+") as f:
        ...
        # outline
        f.write(line(-3.25, -2, rm * (pins - 1) + 3.25, -2))
        f.write(line(-3.25, 10, rm * (pins - 1) + 3.25, 10))
        f.write(line(-3.25, 8, rm * (pins - 1) + 3.25, 8))
        f.write(line(-3.25, 10, -3.25, -2))
        f.write(line(rm * (pins - 1) + 3.25, 10, rm * (pins - 1) + 3.25, -2))
...
def eurostyle_RM350_up_gen(pins):
    ...
    with open(filename + ".kicad_mod", mode = "w+") as f:
        ...
        f.write(line(-rm / 2, -5, rm * (pins - 1) + rm / 2, -5, "Margin"))
        f.write(line(-rm / 2, 6.5, -rm / 2, -5, "Margin"))
        f.write(line(rm * (pins - 1) + rm / 2, 6.5, rm * (pins - 1) + rm / 2, -5, "Margin"))
        ...
        for i in range(pins):
            ...
            f.write(line(rm * i - 1, 4, rm * i + 1, 4, "Margin"))
            f.write(line(rm * i - 1, 1.5, rm * i + 1, 1.5, "Margin"))
            f.write(line(rm * i - 1, 4, rm * i - 1, 1.5, "Margin"))
            f.write(line(rm * i + 1, 4, rm * i + 1, 1.5, "Margin"))
